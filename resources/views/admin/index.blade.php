                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="task-box color-one">
                                        <div class="task-media">
                                            <div class="task-icon">
                                                <img src="{{ asset('template/admin/img/icons/icon-01.png') }}"
                                                    alt="Icons">
                                            </div>
                                            <div class="task-info">
                                                <h5>Pending Tasks</h5>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="task-box color-two">
                                        <div class="task-media">
                                            <div class="task-icon">
                                                <img src="{{ asset('template/admin/img/icons/icon-02.png') }}"
                                                    alt="Icons">
                                            </div>
                                            <div class="task-info">
                                ...
                                <div class="col-md-12">
                                    <div class="task-box color-three">
                                        <div class="task-media">
                                            <div class="task-icon">
                                                <img src="{{ asset('template/admin/img/icons/icon-03.png') }}"
                                                    alt="Icons">
                                            </div>
                                            <div class="task-info">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="#" class="avatar"><img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-19.jpg') }}"></a>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="client-profile.html" class="avatar"><img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-07.jpg') }}"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="client-profile.html" class="avatar"><img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-06.jpg') }}"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="client-profile.html" class="avatar"><img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-14.jpg') }}"></a>
